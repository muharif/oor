...
{
    char command[256];
    snprintf(command, sizeof(command), "/home/arif/grpc/helloworld/greeter_client %s", lisp_addr_to_char(laddr) );
    system(command);

    char command2[256];
    snprintf(command2, sizeof(command2), "/home/arif/grpc/helloworld/greeter_client find");
    system(command2);
